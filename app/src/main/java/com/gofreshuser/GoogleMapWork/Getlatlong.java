...
import com.gofreshuser.Fragment.Add_delivery_address_fragment;
...
public class Getlatlong extends AppCompatActivity implements PlaceAutocompleteAdapter.PlaceAutoCompleteInterface, GoogleApiClient.OnConnectionFailedListener,
...
//     city_name = placePref.getString(PreferenceClass.CURRENT_LOCATION_ADDRESS,"");
        ...
        getLatlngBounds();
        Add_delivery_address_fragment.value="true";
    ...
    public void getLatlngBounds(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Getlatlong.this);

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Baseurl.GET_CITY_BOUNDRIES+finalCityName,null, new Response.Listener<JSONObject>() {
            @Override
                        ...
                        (Request.Method.GET, stringBuilder.toString(), null, new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject jsonResults) {
                                ...
                                try {
                                    ...
                                    Animatoo.animateSwipeRight(Getlatlong.this);
