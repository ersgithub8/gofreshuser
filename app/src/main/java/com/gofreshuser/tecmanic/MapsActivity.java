...
import com.gofreshuser.GoogleMapWork.SearchPlaces;
...
public class MapsActivity extends AppCompatActivity
    ...
    SharedPreferences.Editor loceditorr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        long_=locationpre.getString("lng","");
...
//            long_ = ""+ Double.parseDouble("74.2906989");
        ...
        current_text_tv.setText(locationpre.getString("locationline",""));
        ...
        save_loc_div.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loceditor.putString("lat",lat);

                loceditor.putString("lng",long_);
...
//        }
        ...
        if (mGoogleMap != null) {
            ...
            if (ActivityCompat.checkSelfPermission(getApplicationContext()
                ...
                //                                          int[] grantResults)
                // to handle the case where the user g
                // rants the permission. See the documentation
...
//                            SharedPreferences.Editor editor = sPredMap.edit();
                            ...
                            String longitude=String.valueOf(long_);
