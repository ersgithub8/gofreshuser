...
public class Delivery_get_address_adapter extends RecyclerSwipeAdapter<Delivery_get_address_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_address, tv_name, tv_phone, tv_charges,tv_pincode;
        ...
        public MyViewHolder(View view) {
            ...
            buttonDelete = (Button) itemView.findViewById(R.id.delete_address);
            btn_edit = (Button) itemView.findViewById(R.id.edit_address);
            tv_pincode=itemView.findViewById(R.id.tv_pin);
            ...
            rb_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getsocity = modelList.get(clickedPos).getAddress();
    ...
    public void onBindViewHolder(final Delivery_get_address_adapter.MyViewHolder holder, final int position) {
        ...
        holder.tv_charges.setText("Rs"+mList.getDelivery_charge());
       holder.tv_pincode.setText(mList.getPincode());
        ...
        if (position == 0 /*&& mList.getIscheckd() && holder.rb_select.isChecked()*/) {
            ...
            getsocity = modelList.get(0).getAddress();
        ...
        holder.btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                args.putString("address",mList.getAddress());
